    ...
    public partial class alltables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enrollments", x => new { x.ApplicationUserId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Paragraph = table.Column<string>(type: "varchar(400)", nullable: true),
                    ContentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContentTexts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContentTexts_Contents_ContentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Answer = table.Column<string>(type: "varchar(50)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentTexts_ContentId",
                table: "ContentTexts",
                column: "ContentId");
